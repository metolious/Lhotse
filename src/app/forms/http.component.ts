...
//clearNonConfirmedValues ( ) {
 
  
  // let xx:HTMLCollection= this.document.getElementsByClassName ("ui-chips-input-token");
...
protected doHttp_Post (  httpPostData:any ):Observable<Object>  {
      ...
      console.log ("HttpBase.doHttp_Post JSON.stringify(httpPostData) ==> ["+ JSON.stringify(httpPostData) + "]");
